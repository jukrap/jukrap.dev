		...
		<section className="flex flex-col items-center gap-8 md:gap-16 px-4">
			<div className="flex flex-col items-center gap-6 md:gap-8 text-center break-keep">
				...
				<a
					...
					download
					className="relative flex items-center gap-2 px-4 py-2 font-bold text-lg md:text-xl leading-5 text-center text-background bg-foreground rounded-lg interactive-soft hover:bg-accent transition-colors duration-200 select-none"
				>
