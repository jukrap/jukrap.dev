...
export const projectsData: ProjectType[] = [
	...
	},
	{
		...
		links: [
			...
			{ type: 'googlePlay', url: '/', visible: false },
			{ type: 'github', url: 'https://github.com/jukrap/rn-ShareBBy', visible: true },
	...
	},
	{
		...
		links: [
			{ type: 'appStore', url: '/', visible: false },
			{ type: 'googlePlay', url: 'https://play.google.com/store/apps/details?id=com.gnupr.postureteacher', visible: true },
			{ type: 'github', url: 'https://github.com/jukrap/Posture-Teacher', visible: true },
			{ type: 'url', url: '/', visible: false },
			{ type: 'detailView', url: '/detailView', visible: false },
		],
	},
	{
		...
		links: [
			{ type: 'appStore', url: '/', visible: false },
			{ type: 'googlePlay', url: '/', visible: false },
			{ type: 'github', url: 'https://github.com/jukrap/Chatterbox', visible: true },
			{ type: 'url', url: '/', visible: false },
			{ type: 'detailView', url: '/detailView', visible: false },
		],
	},
	{
		...
		links: [
			{ type: 'appStore', url: '/', visible: false },
			{ type: 'googlePlay', url: '', visible: false },
			{ type: 'github', url: 'https://github.com/yewon5858/Croffle-Project', visible: true },
			{ type: 'url', url: '/', visible: false },
			{ type: 'detailView', url: '/detailView', visible: false },
		],
	},
	{
		...
		links: [
			{ type: 'appStore', url: '/', visible: false },
			{ type: 'googlePlay', url: '/', visible: false },
			{ type: 'github', url: 'https://github.com/jukrap/RollCakeProject', visible: true },
			{ type: 'url', url: '/', visible: false },
			{ type: 'detailView', url: '/detailView', visible: false },
		],
	},
