...
export const projectsDetailData: ProjectDetailType[] = [
	...
	},
	{
		...
		functions: [
			{
				title: '타이머 기능',
				details: ['측정과 관련된 타이머를 설정할 수 있습니다.'],
			},
			{
				title: '앉은 자세 페이지',
				details: ['앉은 자세에 대한 측정을 할 수 있습니다.'],
			},
			{
				title: '플랭크 자세 페이지',
				details: ['플랭크 자세에 대한 측정을 할 수 있습니다.'],
			},
			{
				title: '통계 페이지',
		...
		impression: [
			{
				...
				details: [
					...
					'물론 어떻게 해야 고객 중심적인 서비스를 개발할 것인지, 고객에게 편한 서비스가 대체 무엇인지에 대해서도 논하였습니다. 덕분에 서로의 코드를 이해 및 리뷰하고 원활한 개발을 하는데 큰 도움이 되었습니다.',
				],
			},
			{
			...
			{
				title: '경남소프트웨어경진대회 본선',
				details: [
					'예선 통과 후 본선까지 진출하였습니다. 이후 해당 앱을 구글 플레이스토어에 내놓으면서 배포를 완료했습니다.',
				],
			},
		],
		projectData: {
